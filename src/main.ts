...
@angular/platform-browser-dynamic module.
platformBrowserDynamic is responsible for dynamically bootstrapping 
an Angular application in a browser environment.
